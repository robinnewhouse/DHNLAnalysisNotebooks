...
def compare_histograms(config_file, selection):
	...
	# 	hist_channels.append([config_file["dataFile"],"( data VSI", "{}".format(vtx_channel), selection])
		...
		hist_channels.append([config_file["dataFile"],"( 0mm d0 w LRT cuts", "{}_LRTR3_0p0".format(vtx_channel), selection])
		hist_channels.append([config_file["dataFile"],"( 1mm d0 ", "{}_d0min_1p0".format(vtx_channel), selection])
		hist_channels.append([config_file["dataFile"],"( 1mm d0 w LRT cuts", "{}_LRTR3_1p0".format(vtx_channel), selection])
		hist_channels.append([config_file["dataFile"],"( 2mm d0 w LRT cuts", "{}_LRTR3_2p0".format(vtx_channel), selection])
		hist_channels.append([config_file["dataFile"],"( original ", "{}".format(vtx_channel), selection])
